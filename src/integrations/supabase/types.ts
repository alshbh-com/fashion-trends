  ...
  public: {
    Tables: {
      ...
      agent_daily_closings: {
        ...
        Relationships: [
          {
            foreignKeyName: "adc_agent_id_fkey"
      ...
      analytics_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "ae_product_fkey"
            columns: ["product_id"]
            isOneToOne: false
      ...
      cashbox_transactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "cbtx_cashbox_id_fkey"
            columns: ["cashbox_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "cbtx_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
      ...
      order_status_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "osh_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
            referencedRelation: "orders"
            referencedColumns: ["id"]
      ...
      scan_logs: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "sl_session_fkey"
            columns: ["session_id"]
            isOneToOne: false
      ...
      scan_session_items: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "ssi_session_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "scan_sessions"
            referencedColumns: ["id"]
